    ...
    <div class="row h-100 justify-content-center align-items-center">
        <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8 col-11">
            <div class="main_block">
                ...
                <form id="registration" action="registration.php" method="post" class="login_form needs-validation" novalidate>
                    ...
                    <button id="registration_submit" type="submit" class="login_btn btn btn-primary btn-block">Зарегистрироваться</button>
                </form>
            </div>
        </div>
    </div>
