        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close no_draggable" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <label class="main_name_label" for="main_name">Название новой сущности:</label>
                    <input type="text" name="main_name" class="form-control name_diagramm no_draggable"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn_bg_color no_draggable" id="btn_new_main">Создать
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="attribute_name" class="form-control name_attribute no_draggable"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control no_draggable" name="attr_datatype" title=""></select>
                    </div>
                    <div class="form-group row attribute_data_len">
                        <label for="attr_data_len" class="col-8 col-form-label">Количество символов (длина
                            атрибута)</label>
                        <div class="col-4">
                            <input type="number" class="form-control no_draggable" name="attr_data_len" title="" min="1"
                                   max="9999" required>
                            <div id="attribute_data_len_invalid_feedback"></div>
                        </div>
                    </div>
                    <div class="big_checkbox_form form-check">
                        <input class="big_checkbox form-check-input no_draggable" type="checkbox" value=""
                               name="primary_key"
                               title="">
                ...
                <form id="form_new_relationship">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                Главная сущность
                                <select multiple class="form-control no_draggable" name="rel_first_main"
                                        title=""></select>
                                Степень соединения
                                <select class="form-control no_draggable" name="rel_type" title=""></select>
                            </div>
                            <div class="col-sm">
                                Второстепенная сущность
                                <select multiple class="form-control no_draggable" name="rel_second_main"
                                        title=""></select>
                                Описание связи
                                <input type="text" name="rel_description"
                                       class="form-control name_attribute no_draggable"
                        ...
                        <div class="row rel_identity">
                            <div class="col-sm">
                                Тип соединения
                                <select class="form-control no_draggable" name="rel_identity" title=""></select>
                            </div>
                        </div>
                        <div class="error"></div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary no_draggable" data-dismiss="modal">Закрыть
                        </button>
                        <button type="submit" class="btn btn-primary btn_bg_color no_draggable"
                                id="btn_new_relationship">
                            Создать
                        </button>
                    </div>
                </form>
    ...
    <div class="modal fade" id="get_sql_code" tabindex="-1" role="dialog" aria-labelledby="message_box"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body no_draggable">
                    <div id="input_block" class="mb-3">
                        ...
                        <div id="sql_code_editor" class="no_draggable"></div>
                    </div>
                    <div id="output_block">
                        <h6 class="modal-title" id="mssql_result_description">
                            Результат выполнения запроса на сервере:
                        </h6>
                        <div id="result_viewer" class="mb-2 no_draggable"></div>
                        <table id="result_table" class="table table-striped table-bordered no_draggable"
                               style="width:80%"></table>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn_bg_color no_draggable" id="insert_sql_to_server">
                        Выполнить запрос
                    </button>
                    <button type="button" class="btn btn-secondary no_draggable" data-dismiss="modal">Закрыть</button>
                </div>
                ...
                <form id="form_new_mssql_connect" novalidate>
                    <div class="modal-body">
                        <div class="mssql_connection_form">
                            <h6 class="modal-title mssql_connect_description" id="mssql_connect_description">
                                Подключение не установлено,
                                пожалуйста пройдите авторизацию, чтобы продолжить создание физической модели.
                            </h6>
                            <br>
                            <div class="form-group">
                                <label for="inputAddress">Имя сервера, порт</label>
                                <input type="text" class="form-control no_draggable" id="mssql_server"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control no_draggable" id="mssql_login"
                                           placeholder="Login"
                                           required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="password" class="form-control no_draggable" id="mssql_password"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control no_draggable" id="database_name"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary no_draggable" data-dismiss="modal">
                            Закрыть
                        </button>
                        <button type="submit" class="btn btn-primary btn_bg_color no_draggable" id="btn_new_connect">
                            Соеднить
                        </button>
                    </div>
                </form>
    ...
    <div class="modal fade" id="get_diagram_img" tabindex="-1" role="dialog" aria-labelledby="message_box"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="" download="export.png" id="download_diagram_img"
                       class="btn btn-primary btn_bg_color no_draggable">
