    ...
    <div class="modal fade" id="new_main" tabindex="-1" role="dialog" aria-labelledby="new_diagramm"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="form_new_main" class="needs-validation">
                    <div class="modal-body">
                        ...
                        <div id="main_name_invalid_feedback">
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="form_new_attribute">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Закрыть</button>
                        <button id="btn_new_attribute" type="submit" class="btn btn-primary btn_bg_color">Добавить!
                        </button>
                    </div>
                </form>
            </div>
